...
<form name="form" method="post">
    <table border="0" cellpadding="2" cellspacing="2" align="center"
        ...
        <tr>
            <td colspan="2" align="center" style="font-size:14px;">ALIAS DEL SISTEMA A REGISTRAR EN BD -
                <b><?= $tra['sistema']['alias'] ?></b></td>
        </tr>
        <tr>
            <td height="30"></td>
        </tr>
        ...
        <tr>
            <td colspan="2" align="center" style="background-color:#666; color:#CCC;">INGRESE LOS DATOS DEL USUARIO
                ADMINISTRADOR
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="right"><input type="submit" name="accion" value="aceptar"
                                                 onclick="validar(); return false;"/></td>
        </tr>
    </table>
