...
include $_SERVER['DOCUMENT_ROOT'].'/sgprediex/fuentestra/funciones/php/color.inc.php';
include $_SERVER['DOCUMENT_ROOT'].'/sgprediex/fuentestra/funciones/php/htmlparser.inc.php';
