...
$c++;	$matriz[0][$c]['html']='&nbsp;';		$matriz[0][$c]['width']=16;		$matriz[0][$c]['style']='text-align:center;';		$matriz[0][$c]['permiso']='genT1';
$c++;	$matriz[0][$c]['html']='&nbsp;';		$matriz[0][$c]['width']=16;		$matriz[0][$c]['style']='text-align:center;';		$matriz[0][$c]['permiso']='genT1';
...
while($row=$db->get_array()){
	...
	$matriz[$c][]['html']='<div style="width:16px;height:16px;"><a href="javascript:cargarSeccion(\'generador_tipo1\',\'ae\',\'idT1='.$row['id_generador_abm'].'\',\'ventana\');" title="editar"><img src="fuentestra/imagenes/bot/16x16/edit.png" /></a></div>';
	$matriz[$c][]['html']='<div style="width:16px;height:16px;"><a href="javascript:dialogo(\'Confirma que desea eliminar este registro\',\'si:eliminarT1('.$row['id_generador_abm'].');|no\',\'eliminar\');" title="eliminar"><img src="fuentestra/imagenes/bot/16x16/delete.png" /></a></div>';
